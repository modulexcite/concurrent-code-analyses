...
namespace Utilities
{
    public class Enums
    {
        ...
        public enum AsyncDetected { APM = 0, EAP = 1, TAP = 2, Thread = 3, Threadpool = 4, AsyncDelegate = 5, BackgroundWorker = 6, Task = 7, ISynchronizeInvoke = 8, ControlInvoke = 9, Dispatcher = 10, None };
