...
def main():
	address= "http://www.codeplex.com/site/search?query=&sortBy=Title&tagName=%2cWindows%20Phone%208%2c&licenses=|&refinedSearch=true&size=100&page="
