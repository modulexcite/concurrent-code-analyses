...
namespace Analysis
{
    internal class ThreadTaskProjectAnalysisWalker : SyntaxWalker
    {
        ...
        public ThreadTaskProjectAnalysis Outer;
        public String Id;
        ...
        public ThreadTaskProjectAnalysisWalker(ThreadTaskProjectAnalysisSummary summary)
        {
            _summary = summary;
        }
